...
const Edit = () => {
	...
	const HANDLE_SUBMIT = async (e) => {
		...
		await axios.post('/api/positions/edit', {
			_id: position_edit_data._id, position, rate
		}).then((response) => {
			...
			<Wrapper>
				...
				<Items>
					<form onSubmit={ HANDLE_SUBMIT }>
						<input type="text" placeholder="Position" name="position" value={ position } onChange={ HANDLE_INPUTS } />
						<input type="text" placeholder="Rate Per Hour" name="rate" value={ rate } onChange={ HANDLE_INPUTS } />
