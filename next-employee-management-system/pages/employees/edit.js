			...
			<Wrapper>
				...
				<Items>
					<form onSubmit={ HANDLE_SUBMIT }>
						<input type="text" name="id" value={ id } onChange={ HANDLE_INPUTS } disabled />
						<input type="text" placeholder="Username" name="username" value={ username } onChange={ HANDLE_INPUTS } />
						<input type="text" placeholder="Firstname" name="firstname" value={ firstname } onChange={ HANDLE_INPUTS } />
						<input type="text" placeholder="Lastname" name="lastname" value={ lastname } onChange={ HANDLE_INPUTS } />
						<input type="text" placeholder="Address" name="address" value={ address } onChange={ HANDLE_INPUTS } />
						<input type="text" placeholder="Contact" name="contact" value={ contact } onChange={ HANDLE_INPUTS } />
						<input type="date" placeholder="Birthdate" name="birthdate" value={ birthdate } onChange={ HANDLE_INPUTS } />
