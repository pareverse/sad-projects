...
const Edit = () => {
	...
	const HANDLE_SUBMIT = async (e) => {
		...
		await axios.post('/api/deduction/edit', {
			_id: deduction_edit_data._id, name, amount
		}).then((response) => {
			...
			<Wrapper>
				...
				<Items>
					<form onSubmit={ HANDLE_SUBMIT }>
						<input type="text" placeholder="Name" name="name" value={ name } onChange={ HANDLE_INPUTS } />
						<input type="text" placeholder="Amount" name="amount" value={ amount } onChange={ HANDLE_INPUTS } />
