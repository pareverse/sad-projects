...
const Add = () => {
	...
	const HANDLE_SUBMIT = async (e) => {
		...
		await axios.post('/api/deduction/add', {
			name, amount
		}).then((response) => {
			...
			<Wrapper>
				...
				<Items>
					<form onSubmit={ HANDLE_SUBMIT }>
						<input type="text" placeholder="Name" name="name" onChange={ HANDLE_INPUTS } />
						<input type="text" placeholder="Amount" name="amount" onChange={ HANDLE_INPUTS } />
